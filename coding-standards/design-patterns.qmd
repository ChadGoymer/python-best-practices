...
1.  [lloydsdb](https://github/pages/mrc/lloyds-packages): lloydsdb is a package that
    provides a common way to read and write data from a Lloyd's database. It also contains
    a general approach for running processes and capturing outputs and an audit trail.
2.  [lloydsbrand](https://github/pages/mrc/lloyds-branding): lloydsbrand is a package that
    provides styling and formatting option for applications and reports, so they follow
