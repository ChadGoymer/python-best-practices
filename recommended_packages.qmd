...
wrangling in Python, and may be used, it is recommended to use [Polars](https://docs.pola.rs/)
instead. Polars is more performant and has more readable syntax. It is built to chain
methods in an elegant way, for example:
...
[lloydsdb](lloydsdb.qmd) for more details.
