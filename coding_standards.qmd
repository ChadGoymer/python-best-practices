...
Styling your code in a consistent way makes it easier to read. Having agreed conventions
for file, variable and function names, will make it easier to locate and use code. In
addition, having spaces around operators and splitting up long lines make it easier to
read.
:::
